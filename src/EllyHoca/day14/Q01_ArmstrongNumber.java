    ...
    private static void armstrong(int sayi){
     ...
     int girilenSayi=sayi;
      ...
      while(sayi>0){ // hr bir rakama erişmek için
        ...
        System.out.println(girilenSayi + " sayisi armstrong sayi değildir");
