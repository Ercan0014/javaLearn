...
public class Task12 {
    ...
    */
        ...
        String mailAdres = scan.nextLine();

        System.out.println(hesapKontrol(mailAdres));


    }//main soun

    public static boolean hesapKontrol (String mailAdres){
    return mailAdres.contains("@") && mailAdres.contains(".") && mailAdres.indexOf("@")>0;
    }
}
