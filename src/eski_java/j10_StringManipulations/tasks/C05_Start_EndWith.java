 ...
 */
    ...
    */
        ...
        System.out.println("bir gmail hesabı giriniz : ");
        String mailhesabı = sc.nextLine();
        String b="@gmail.com";

    //   if (mailhesabı.contains(b)){
    //       if (mailhesabı.endsWith(b)){
    ...
    //   }else System.out.println("lütfen gmail hesabı giriniz");
        ...
        System.out.println(mailhesabı.contains(b) ? ((mailhesabı.endsWith(b) ? "hesabınız onaylandı" : "geçerli hesap giriniz")) : "lutfen mail hesabı giriniz");
