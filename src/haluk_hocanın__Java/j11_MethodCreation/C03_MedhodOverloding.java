...
public class C03_MedhodOverloding {
...
public static void topla(int sayı1, int sayı2){
    System.out.println("int-int type method çalıştı" + (sayı1+sayı2));


    }
    public static void topla(double sayı1, int sayı2){
        System.out.println("double-int type method çalıştı" + (sayı1+sayı2));


    }
    public static void topla(int sayı1, double sayı2){
        System.out.println("int-double type method çalıştı" + (sayı1+sayı2));


    }

    public static void topla(double sayı1, double sayı2){
        System.out.println("double-double type method çalıştı" + (sayı1+sayı2));
