...
public class merveSoru {
    ...
    Belirli bir tamsayı dizisinin tek ve çift sayılarını ayıran bir Java programı yazın.
    Önce tüm tek sayıları, ardından çift sayıları koyun.
